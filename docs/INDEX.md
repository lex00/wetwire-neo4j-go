...
| Migrate existing schemas | [IMPORT_WORKFLOW.md](IMPORT_WORKFLOW.md) |

## By Audience

### New Users
1. [QUICK_START.md](QUICK_START.md) - Build your first Neo4j schema
2. [FAQ.md](FAQ.md) - Common questions and troubleshooting
3. [EXAMPLES.md](EXAMPLES.md) - Real-world schema patterns

### Regular Users
- [CLI.md](CLI.md) - Complete command reference
- [LINT_RULES.md](LINT_RULES.md) - All WN4 rules with examples

### Team Adoption
- [ADOPTION.md](ADOPTION.md) - Migration strategies and team onboarding
- [IMPORT_WORKFLOW.md](IMPORT_WORKFLOW.md) - Convert existing Cypher schemas
...
| [LINT_RULES.md](LINT_RULES.md) | WN4001-WN4069 rule reference | All users |
| [FAQ.md](FAQ.md) | Common questions and troubleshooting | All users |
| [EXAMPLES.md](EXAMPLES.md) | Schema patterns and examples | Learning users |
| [ADOPTION.md](ADOPTION.md) | Team migration and onboarding | Team leads |
| [IMPORT_WORKFLOW.md](IMPORT_WORKFLOW.md) | Convert existing schemas | Migrating users |
| [DEVELOPERS.md](DEVELOPERS.md) | Development setup | Contributors |
| [ARCHITECTURE.md](ARCHITECTURE.md) | System design | Contributors |
| [INTERNALS.md](INTERNALS.md) | Implementation details | Contributors |
